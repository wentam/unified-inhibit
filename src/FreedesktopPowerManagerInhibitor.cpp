...
void THIS::handleInhibitStateChanged(InhibitType inhibited, Inhibit inhibit) {
	...
	int32_t send = 0;
  if (inhibited & InhibitType::SUSPEND) send = 1;
	dbus.newSignal(PATH, INTERFACE, "HasInhibitChanged")
